		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
			    		<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; float:left; width:100%; padding:20px;text-align:center; font-size: 13px;">
									...
									<img src="" width="250" alt="Metronic" border="0"  /></font></a>
					</td>
					<td align="right">
				<!--[endif]--><!-- 
...
?>
			...
			<tr><td align="center">
				<div style="line-height: 24px;">
					<a href="<?=base_url()?>/admin" target="_blank" class="btn btn-danger block-center">
					    Panel Admin
					</a>
				</div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					Copyright © wtgibelanegara.com 2017. All right reserved. Designed by: gatewan.com
				</span></font>				
			</td></tr>			
		</table>
	</td></tr>
